...
ccd_camera_objective_mode = PV('32idcTXM:obj:mode.VAL')
ccd_camera_objective_label_0 = PV('32idcTXM:obj:mode.ZRST')
ccd_camera_objective_label_1 = PV('32idcTXM:obj:mode.ONST')
ccd_camera_objective_label_2 = PV('32idcTXM:obj:mode.TWST')

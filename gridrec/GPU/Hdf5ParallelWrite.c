...
void Hdf5ParallelReconDataSet(const char* filename, const char* datasetname, int nWidth, int nHeight, int nDepth ){
...
void Hdf5ParallelWriteZ(const char* filename, const char* datasetname, int nZSliceStart, int numZSlice, int commRank,
			int xm, int ym, float * data){
...
/* void Hdf5ParallelWriteY(char* filename, char* datasetname, int nYSliceStart, int numYSlice,  int commRank,  */
/* 		     HDF5_DATATYPE * data){ */

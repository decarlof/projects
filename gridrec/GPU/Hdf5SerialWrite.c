...
void Hdf5SerialReconDataSet(const char* filename, const char* datasetname, int nWidth, int nHeight, int nDepth ){
...
void Hdf5SerialWriteZ(const char* filename, const char* datasetname, int nZSliceStart, int numZSlice, 
			int commRank, int xm, int ym, float * data){

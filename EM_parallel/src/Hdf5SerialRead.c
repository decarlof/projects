...
// Read data from projection data file (.hdf5). Data type: unsighed short (16 bit)
// Be sure to update H5T_STD_U16LE (unsigned short) when HDF5_DATATYPE changes

void Hdf5SerialReadZ(const char* filename, char* datasetname, int nZSliceStart, int numZSlice,  
		     HDF5_DATATYPE * data){
...
void Hdf5SerialReadY(const char* filename, char* datasetname, int nYSliceStart, int numYSlice,  
		     HDF5_DATATYPE * data){

...
void Hdf5GetDims(char* filename, char* datasetname, int* xm, int * ym, int * zm){

  // Read *.hdf5 and get the dimension of dataset name
...
void Hdf5SerialReadZ(char* filename, char* datasetname, int nZSliceStart, int numZSlice,  
		     HDF5_DATATYPE * data){

  // Read *.hdf5 in the z direction 
...
void Hdf5SerialReadY_f(char* filename, char* datasetname, int nYSliceStart, int numYSlice,  
		     float * data){
